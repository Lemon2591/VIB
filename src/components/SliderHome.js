...
function SliderHome() {
  return (
    <div className="slider-home-container">
      ...
      <div className="slider-card-content slider-card-content-mb">
        <div className="slider-card-items">
          <Swiper className="mySwiper">
            <SwiperSlide>
              <NavLink to="/vaymuanha" className="slider-card-item group">
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Vững tin làm chủ cuộc sống với ngôi nhà mơ ước từ khoản
                      vay thế chấp với hạn mức cho vay lên đến 75%, kỳ hạn tối
                      đa đến 25 năm. Phê duyệt nhanh chóng chỉ trong 01 ngày.
                    </div>
                    <img
                      src="https://vaythechap.vpbank.com.vn/media/public/2021/10/09/c7e11046-160d-42b7-975e-391f16262de1.jpg"
                      alt="image-product"
            ...
            <SwiperSlide>
              {" "}
              <NavLink
                to="/vaykinhdoanhthechap"
                className="slider-card-item group"
              >
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  <div className="back h-full">
                    <img
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Tự tin kinh doanh, mở rộng quy mô sản xuất – tận hưởng ưu
                      đãi lãi suất từ khoản vay thế chấp với hạn mức cao và phê
                      duyệt nhanh chóng.
                    </div>
                    <img
                      src="https://vaythechap.vpbank.com.vn/media/public/2021/10/09/9a5a58bb-c1a3-490c-b4c3-da8a60a9f87e.jpg"
            ...
            <SwiperSlide>
              ...
              <NavLink to="/vaymuaoto" className="slider-card-item group">
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Lên đời ôtô mới trong chớp mắt nhờ khoản vay thế chấp với
                      hạn mức cho vay lên đến 85%, kỳ hạn tối đa đến 8 năm. Thời
                      gian phê duyệt khoản vay nhanh nhất thị trường chỉ trong
                      05 phút.
                    </div>
                    <img
                      src="https://vaythechap.vpbank.com.vn/media/public/2021/10/09/fab7cdcd-05c3-468a-8b45-3eb1b12a4653.jpg"
            ...
            <SwiperSlide>
              ...
              <NavLink to="/vaymuanhaduan" className="slider-card-item group">
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Dễ dàng sở hữu ngôi nhà mơ ước của riêng mình với các chủ
                      đầu tư bất động sản lớn trên thị trường là đối tác chiến
                      lược của VPBank trong nhiều năm qua và được áp dụng nhiều
            ...
            <SwiperSlide>
              ...
              >
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Tận hưởng cuộc sống tiện nghi – Thỏa thích chi tiêu, mua
                      sắm và xây sửa nhà mà không cần phải chờ đợi tiết kiệm đủ
                      tiền.
                    </div>
                    <img
                      src="https://vaythechap.vpbank.com.vn/media/public/2021/10/09/a57e5422-241c-44a8-9a3c-1fad501f1ec9.jpg"
            ...
            <SwiperSlide>
              ...
              <NavLink to="/combouudai" className="slider-card-item group">
                <div className="card backface w-[24rem] h-[32rem] rounded-md overflow-hidden">
                  ...
                  <div className="front h-full relative">
                    <div className="bg-transparent font-semibold text-[1.5rem] absolute top-5 left-5 right-5 text-gray-50">
                      Dùng càng nhiều sản phẩm, giảm càng sâu lãi suất khi tham
                      gia Combo Business
                    </div>
                    <img
                      src="https://vaythechap.vpbank.com.vn/media/public/2022/07/29/22f51199-c35f-4427-8bc9-bf13a70f66eb.jpg"
